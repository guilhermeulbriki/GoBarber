...
var _ICacheProvider = _interopRequireDefault(require("../../../shared/container/providers/CacherProvider/models/ICacheProvider"));
...
let CreateAppointmentServe = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", [typeof _IAppointmentsRepository.default === "undefined" ? Object : _IAppointmentsRepository.default, typeof _INotificationRepository.default === "undefined" ? Object : _INotificationRepository.default, typeof _ICacheProvider.default === "undefined" ? Object : _ICacheProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = class CreateAppointmentServe {
  ...
  async execute({
    ...
    if ((0, _dateFns.isBefore)(appointmentDate, Date.now())) {
      throw new _AppError.default("You can't create an appointment on a past hour");
    }
    ...
    const dateFormat = (0, _dateFns.format)(appointmentDate, "dd/MM/yyyy 'às' HH:mm'h'");
...
var _default = CreateAppointmentServe;
